...
def least_squares_GD(y, tx, initial_w, max_iters, gamma):
    ...
    max_iters -- maximal iterations of gradient descent
    gamma -- learning rate
    """
    N = y.shape[0]
    D = initial_w.shape[0]
...
def least_squares_SGD(y, tx, initial_w, max_iters, gamma):
    ...
    tx -- the features
    initial_w -- the initial weights
    max_iters -- maximal iterations of stochastic gradient descent
    gamma -- learning rate
    """
    N = y.shape[0]
    D = initial_w.shape[0]
...
def reg_logistic_regression(y, tx, lambda_, initial_w, max_iters, gamma):
    ...
    lambda_ -- shrinkage parameter
    initial_w -- the initial weights
    max_iters -- maximal iterations of penalized logistic regression
    gamma -- learning rate
    """
    N = y.shape[0]
    D = initial_w.shape[0]
